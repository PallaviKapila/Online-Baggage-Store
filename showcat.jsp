                      ...
                      try
        {
            ...
            try
            {
                ...
                if(myres.next()==true)
                {
                    do
                    {
                        out.print("<div class='col-lg-4 col-md-6 col-sm-6 product-men women_two' style='margin:auto !important'>"
                                 +"<div class='product-toys-info'>"
                                 +" <div class='men-pro-item'>"
                                 +"<div class='men-thumb-item'>"
                                 +"<img width='1000' src='uploads/" + myres.getString("catpic")+ "'class='img-thumbnail' alt=''>"
                                 +" </div>"
                                 ...
                                 +"<h4>"
                                 +"<a href='showsubcat.jsp?catid=" + myres.getString("catid")+ "'>"+myres.getString("catname") + "</a>"
                                 +"</h4>"
                                 +"</div>"
                                 +"</div>"
                                 +"</div>"
