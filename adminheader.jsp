<%
                            if(session.getAttribute("n")==null ||!session.getAttribute("utype").toString().equalsIgnoreCase("admin"))
                            {
        ...
        <header class="py-sm-3 pt-3 pb-2" id="home">
            <div class="container">
                ...
                <div class="top-w3pvt d-flex">
                    <div id="logo">
                        <h1> <a href="adminhome.jsp"><span class="log-w3pvt">B</span>aggage</a> <label class="sub-des">Online Store</label></h1>
                    </div>
                ...
                <div class="nav-top-wthree">
                     <nav>
                        ...
                        <ul class="menu">
                             ...
                             <li><a href="managecat.jsp" class="drop-text">Category</a></li>
                             <li><a href="managesubcat.jsp">Sub-Category</a></li>
                             <li><a href="manageprod.jsp">Products</a></li>
                              <li><a href="showcart.jsp">Cart</a></li>
                              <li><a href="orderhis.jsp">Order History</a></li>
                             <li><a href="listofmember.jsp">Members</a></li>
                             <li><a href="srchmember.jsp">Search</a></li>
                             <li><a href="viewmsg.jsp">Messages</a></li>
                    ...
                    <div class="search-form ml-auto">
                        <div class="form-w3layouts-grid">
                            <form action="showres.jsp" method="post" class="newsletter">
