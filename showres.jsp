<%-- 
    Document   : showres
    Created on : 20 Jul, 2019, 5:15:54 PM
    Author     : Pallavi
--%>
    ...
    <body>
      <%
        ...
        <%
         ...
         <section class="contact py-lg-4 py-md-3 py-sm-3 py-5">
         <div class="container-fluid py-lg-5 py-md-4 py-sm-4 py-5">
                      ...
                      try
        {
            ...
            try
            {
                String q = "select * from manageprod where name like ?";
                ...
                if(myres.next()==true)
                {
                    do
                    {
                         out.print("<div class='col-lg-4 col-md-6 col-sm-6 product-men women_two'>"
                                 ...
                                 +"<img style='width:100% !important;height:230px !important' src='uploads/" + myres.getString("prodpic")+ "'class='img-thumbnail' alt=''>"
                                 +" </div>"
